    ...
    <div class="flex flex-col md:flex-row ">
      ...
      <div class="bg-white shadow rounded-lg md:ml-4 md:mt-0 w-full sm:max-w-screen-sm xl:p-0">
        <div class="p-6 sm:p-8 lg:p-16 space-y-8">
          ...
          <form class="mt-8 space-y-6" action="submit-login" method="post" onsubmit="return validateForm()">
            <div>
            ...
            <button type="submit"
              class="bg-blue-800 text-white p-2 rounded w-full hover:bg-white hover:text-blue-800 focus:outline-none focus:ring focus:ring-green-200">Login</button>
